...
namespace Utility.Redis
{
    public partial class ClusterClient
    {
        ...
        public int ListLPush(string key, string[] values)
        {
            ...
            using (client)
            {
                return client.ListLPush(key, values);
            }
        }
        /// <summary>
        ...
        public int ListRPush(string key, string[] values)
        {
            ...
            using (client)
            {
                return client.ListRPush(key, values);
            }
        }
        /// <summary>
        ...
        public int ListLPushX(string key, string value)
        {
            ...
            using (client)
            {
                return client.ListLPushX(key, value);
            }
        }
        /// <summary>
        ...
        public int ListRPushX(string key, string value)
        {
            ...
            using (client)
            {
                return client.ListRPushX(key, value);
            }
        }
        /// <summary>
        /// 通过索引查找值
        ...
        public string ListLIndex(string key, int index)
        {
            ...
            using (client)
            {
                return client.ListLIndex(key, index);
            }
        }
        /// <summary>
        /// 获取列表长度
        ...
        public int ListLRem(string key, int count, string value)
        {
            ...
            using (client)
            {
                return client.ListLRem(key, count, value);
            }
        }
        /// <summary>
        /// 移除并获取列表的第一个元素
        ...
        public int ListLInsertBefore(string key, string pivot, string value)
        {
            ...
            using (client)
            {
                return client.ListLInsertBefore(key, pivot, value);
            }
        }
        /// <summary>
        ...
        public int ListLInsertAfter(string key, string pivot, string value)
        {
            ...
            using (client)
            {
                return client.ListLInsertAfter(key, pivot, value);
            }
        }
        /// <summary>
        /// 返回列中中指定区间内的元素
        ...
        public List<string> ListLRange(string key, int start, int end)
        {
            ...
            using (client)
            {
                return client.ListLRange(key, start, end);
            }
        }
        /// <summary>
        /// 移除并获取列表的最后一个元素
        ...
        public bool ListLTrim(string key, int start, int end)
        {
            ...
            using (client)
            {
                return client.ListLTrim(key, start, end);
            }
        }
    }
}
