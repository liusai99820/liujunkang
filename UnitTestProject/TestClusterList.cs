...
namespace UnitTestProject
{
    ...
    public class TestClusterList
    {
        ...
        {
            testContext.WriteLine("开始对类ClusterList执行单元测试......");
        ...
        public void TestListLPush()
        {
            ...
            client.StringDel("B_1");
            client.StringDel("A_4");
        }
        /// <summary>
        ...
        public void TestListRPush()
        {
            ...
            client.StringDel("B_2");
            client.StringDel("A_5");
        }
        /// <summary>
        ...
        public void TestListLPushX()
        {
            ...
            client.StringDel("B_3");
            client.StringDel("C_1");
        }
        /// <summary>
        ...
        public void TestListRPushX()
        {
            ...
            client.StringDel("B_4");
            client.StringDel("C_2");
        }
        /// <summary>
        /// 通过索引查找值
        /// </summary>
        ...
        public void TestListLIndex()
        {
            ...
            client.StringDel("B_5");
            client.StringDel("A_6");
            client.StringDel("D_1");
        }
        /// <summary>
        /// 获取列表长度
        /// </summary>
        ...
        public void TestListLlenKey()
        {
            ...
            client.StringDel("B_6");
            client.StringDel("A_7");
            client.StringDel("c");
        }
        /// <summary>
        ...
        public void TestListLRange()
        {
            ...
            client.StringDel("B_11");
            client.StringDel("A_8");
        }
        /// <summary>
        /// 移除并获取列表的最后一个元素
        /// </summary>
